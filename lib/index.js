...
function programInit() {
  program.command('init')
    ...
    .option('-y', '重写/node_modules/@dcloudio/vue-cli-plugin-uni/commands/build.js')
  ...
  program
    ...
    .alias('p')
    .on('--help', () => {
      console.log('You can enter u-helper create-page to help you to choice.');
      console.log('  Examples:');
      console.log('');
